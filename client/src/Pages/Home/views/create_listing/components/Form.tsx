...
function Form() {
  ...
  const style = {
    mainDiv: `bg-[#26a59a]/95 relative w-[60%]  max_smm1:w-[160%]  max_xl:w-[90%] max_lg:h-[2000px] max_lg:mt-40 max_lg:w-[100%]   max_xl:h-[100%]  max_lg:items-center max_lg:justify-center h-[930px]  rounded-r-[9px] flex-col flex p-5 gap-5`,
  ...
  return (
    <div ref={createRef} className={style.mainDiv}>
